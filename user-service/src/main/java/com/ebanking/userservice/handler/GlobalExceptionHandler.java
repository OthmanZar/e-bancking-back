package com.ebanking.userservice.handler;
...
public class GlobalExceptionHandler {
        ...
        try {
            ...
            try {
                ...
                return ResponseEntity
                        ...
                        .body(ExceptionResponse.builder()
                                .businessErrorDescription("Unrecognized downstream error Users")
    ...
    public ResponseEntity<ExceptionResponse> handleUserException(UserNotFoundException exp) {

        return ResponseEntity
                .status(INTERNAL_SERVER_ERROR)
                .body(
                        ExceptionResponse.builder()
                                .businessErrorDescription("User Exception")
