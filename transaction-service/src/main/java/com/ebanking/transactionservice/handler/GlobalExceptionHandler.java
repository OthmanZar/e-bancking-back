...
public class GlobalExceptionHandler {
        ...
        try {
            ...
            try {
                ...
                return ResponseEntity
                        ...
                        .body(ExceptionResponse.builder()
                                .businessErrorDescription("Unrecognized downstream error Transaction")
    ...
    public ResponseEntity<ExceptionResponse> handleUserException(BankAccountNotFound exp) {

        return ResponseEntity
                .status(INTERNAL_SERVER_ERROR)
                .body(
                        ExceptionResponse.builder()
                                .businessErrorDescription("Transaction Exception")
