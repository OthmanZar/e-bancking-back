package com.ebanking.atmservice.handler;
...
public class GlobalExceptionHandler {
        ...
        try {
            ...
            try {
                ...
                return ResponseEntity
                        ...
                        .body(ExceptionResponse.builder()
                                .businessErrorDescription("Unrecognized downstream error ATM")
    ...
    public ResponseEntity<ExceptionResponse> handleUserException(AtmNotFoundException exp) {

        return ResponseEntity
                .status(INTERNAL_SERVER_ERROR)
                .body(
                        ExceptionResponse.builder()
                                .businessErrorDescription("ATM Exception")
